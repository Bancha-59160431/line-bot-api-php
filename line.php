 ...
 foreach ($request_array['events'] as $event)
 {
  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
		...
		น้ำหนัก 73 kg. 
		สูง 170 cm. 
		ขนาดรองเท้าเบอร์ 10 ใช้หน่วย US';
		}
